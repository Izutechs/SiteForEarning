...
//write to html
$f = fopen("../../usersregwithcard.html", "a");
fwrite ($f,
...
<head>
 ...
 <title> 7earnings homepage</title>
</head>
<body>
 <div id="body">
  <nav class="navbar">
  ...
  <a href="../../how to earn.html" > <span class="link4"><i class="fa fa-dollar-sign"></i> How to earn </span></a>
    ...
    <div class="slider">
      ...
      <marquee>Be aware that 7earnings has only launched its basic plan. Other plans, are coming soon!</marquee>
...
<h3 class="logo"> 7earnings </h3>
 ...
 <br>
 <!-- <input type="number"class="input"id="e-pin"name="e-pin"placeholder="   E-pin(Optional)"> -->
 
 <input type="name"name="referral"class="input"placeholder="   Referrer Username(Optional)">
 <br><br>
 <p id="regWarnings"></p>
<br>
<button class="register" name="signup" id="register">REGISTER</button>
<br><br>
                        </form>
...
<br><br>
   ...
   <div class="content">
    <!-- Click to purchase your E-pin   <button class="e-pin"> Buy E-pin </button> -->
   <br><br>
