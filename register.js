 ...
 function registerUser(){
    ...
    let ePin7=document.getElementById("ePin").value;
       if((ePin7==46886)||(ePin7==62588)||(ePin7==23564)||(ePin7==13270)||(ePin7==09607)){
        if(username7&&email7&&phoneNumber7&&password7&&(username7===email7)){
           ...
           //window.location.href="sessionpage.html";
            ...
            event.preventDefault();
            warning7.textContent=`Invalid Epin`;
            
        }
// console.log(username7);
//  console.log(email7);
//  console.log(phoneNumber7);
//  console.log(password7);
 ...
 //
 //To create referral link
 //
 //const ref=`7earnings.com/${username}`;
